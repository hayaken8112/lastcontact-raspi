...
# remote_address = "macbookpro-hayashi2.local"
#remote_address = "157.82.206.45"
# remote_address = "169.254.117.233"
remote_address = "169.254.92.61"
...
# 値が大きいと、全部背景として認識する
fgbg = cv2.createBackgroundSubtractorMOG2(0,10)
...
while(1):
    ...
    # print(Y.shape[0])
    if np.max(fgmask) > 200 and Y.shape[0] > MIN_DETECT_AREA:
        #差分箇所の座標と範囲を取得
        Y, X = np.where(fgmask > 200)
